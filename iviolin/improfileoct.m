...
%Modified parameters from Matlab for Octave compatibility / 11.01.2021
function varargout = improfileoct(img,xCoord,yCoord,N)
pCoordinates = [xCoord;yCoord]; %Modified parameters from Matlab for Octave compatibility / 11.01.2021
method = 'nearest';
xysize=size(img);
y = [1,xysize(1)];
x = [1,xysize(2)];
